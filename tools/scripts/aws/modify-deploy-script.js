...
(function() {
  const log = console.log,
      {name, version} = JSON.parse(fs.readFileSync(path.join(__dirname, '../../..', '/backend', 'package.json'))),
      pathToConfigurationFile = path.join(__dirname, '../../..', '.elasticbeanstalk', 'config.yml'),
