module.exports = mapStatistics = [
  ...
  },
  {
    ...
    url:
      "https://api.uis.unesco.org/sdmx/data/UNESCO,EDU_NON_FINANCE,3.0/NER.PT.L1...................?startPeriod=2018&endPeriod=2018&format=sdmx-json&locale=en&subscription-key=",
    startYear: 2018,
    endYear: 2018,
    evaluationType: "percentage",
    evaluation: [
      { key: "firstRange", value: [100, 95] },
      { key: "secondRange", value: [94, 89] },
      { key: "thirdRange", value: [88, 80] },
      { key: "fourthRange", value: [79, 50] },
