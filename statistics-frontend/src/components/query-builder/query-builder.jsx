...
export function QueryBuilder() {
    ...
    const { categoriesList, selectedCategory, setSelectedCategory } = useQueryBuilder();
        ...
        >
            <div className="text-box">
                ...
                <Typography variant="body1" color="textSecondary">
                    This feature heavily relies on the UIS Api. Since UIS is during a migration phase, this feature
                    might not work. In addition
                    multi dimension observations are currently not supported. E.g. an observation between 2017 and 2018
                    is already multi dimensional.
                </Typography>
            </div>
            <StatisticStepperQueryBuilder/>
            {categoriesList && <TextField
                select
                className="select"
                label="Category"
